...
import { TournamentRibbon } from "@/components/world-cup-brand";
    ...
    <html lang="es">
      <body>
        ...
        <header className="sticky top-0 z-20 border-b border-line bg-white text-ink shadow-lg shadow-sky-950/8">
          <nav className="shell app-header-grid grid min-h-16 grid-cols-[auto_1fr] items-center gap-2 py-3 sm:gap-3">
