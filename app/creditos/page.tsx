            ...
            <div className="mt-6 grid gap-3">
              <div className="rounded-lg border border-line bg-field p-4">
                ...
                <p className="mt-1 text-sm font-semibold text-ink/70">
                  Por crear el Excel original en 2010, bancar la competencia y dejar servido el espiritu del Mundialito.
                </p>
              </div>
              <div className="rounded-lg border border-line bg-field p-4">
                ...
                <div className="mt-3 rounded-lg bg-mint p-3">
                  <span className="text-xs font-black uppercase text-grass">Recaudado para Ecuador</span>
                  <strong className="mt-1 block text-2xl">{money(summary.missionFund)}</strong>
                </div>
              </div>
              <div className="rounded-lg border border-line bg-field p-4">
